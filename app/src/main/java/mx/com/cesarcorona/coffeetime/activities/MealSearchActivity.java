...
import static mx.com.cesarcorona.coffeetime.fragment.MealOptionsFragment.KEY_CATEGORIA;

public class MealSearchActivity extends BaseAnimatedActivity implements CoffeDate.FillInformationInterface , CoffeDateAdapter.MatchingInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent homeActivity = new Intent(MealSearchActivity.this, MainSettingsActivity.class);
    ...
    public void OnDataChangeSuccess() {
        ...
        if(numberOfSrikes == availableDates.size() && numberErrors == 0){
            ...
            coffeDateAdapter.setMatchingInterface(MealSearchActivity.this);
    ...
    public void OnConnectButton(CoffeDate coffeDate) {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Toast.makeText(MealSearchActivity.this,"Meal Date Complete",Toast.LENGTH_LONG).show();
    ...
    public void OnReview(CoffeDate coffeDate) {
        Intent intent= new Intent(MealSearchActivity.this, ReviewActivity.class);
